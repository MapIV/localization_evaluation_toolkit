...
if __name__ == "__main__":
    ...
    if pose_empty == False and nvtl_empty == False:
        ...
        scatter_nvtl = ax_trj_nvtl.scatter(pose_.df_temp["x"], pose_.df_temp["y"], c=nvtl_.df["data"], cmap='jet_r')
    ...
    if pose_empty == False and tp_empty == False:
        ...
        scatter_tp = ax_trj_tp.scatter(pose_.df_temp["x"], pose_.df_temp["y"], c=tp_.df["data"], cmap='jet_r')
    ...
    if exe_time_empty == False:
        ...
        ax_exe_time.plot(exe_time_.df_temp["time"] - exe_time_.df_temp.at[0,"time"], exe_time_.df_temp["data"], marker="o", c="b", markersize=2)
